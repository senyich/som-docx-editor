 ...
 * @public
 */
type LocaleCode = 'en' | 'de' | 'fr' | 'he' | 'hi' | 'pl' | 'pt-BR' | 'ru' | 'tr' | 'zh-CN';
...
declare const ru: PartialLocaleStrings;
...
export { type DeepPartial, type LocaleCode, type LocaleStrings, type PartialLocaleStrings, type TFunction, type TranslationKey, type Translations, createT, de, deepMerge, en, fr, he, hi, locales, pl, ptBR, ru, tr, zhCN };
