...
import type { NumberFormat } from '@som/docx-editor-core/types/document';
...
export type { ListType, ListState } from '@som/docx-editor-core/utils/listState';
import type { ListState } from '@som/docx-editor-core/utils/listState';
...
export {
  ...
  toggleListType,
} from '@som/docx-editor-core/utils/listState';
