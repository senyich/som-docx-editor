...
// Layout bridge
import { DEFAULT_PAGE_HEIGHT_PX } from '@som/docx-editor-core/layout-bridge';
...
export interface PagedEditorProps {
  ...
  extensionManager?: import('@som/docx-editor-core/prosemirror/extensions').ExtensionManager;
