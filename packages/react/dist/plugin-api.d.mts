import { P as PluginHostProps, a as PluginHostRef, b as ReactEditorPlugin } from './types-C8QZ-0eE.mjs';
export { E as EditorPlugin, c as PluginContext, R as ReactSidebarItem, S as SidebarItemRenderProps } from './types-C8QZ-0eE.mjs';
import * as React from 'react';
export { RenderedDomContextImpl, createRenderedDomContext } from '@som/docx-editor-core/plugin-api/RenderedDomContext';
import { TemplateTag } from '@som/docx-editor-core/prosemirror/template/prosemirror-plugin';
export { TEMPLATE_DECORATION_STYLES, TagType, TemplateTag, createTemplatePlugin as createTemplateProseMirrorPlugin, getTemplateTags as getTemplatePluginTags, setHoveredElement, setSelectedElement, templatePluginKey } from '@som/docx-editor-core/prosemirror/template/prosemirror-plugin';
export { PanelConfig, PluginPanelProps, PositionCoordinates, RenderedDomContext, SidebarItem, SidebarItemContext } from '@som/docx-editor-core/plugin-api';
