...
export { C as CreateEmptyDocumentOptions, P as ProcessTemplateOptions, a as ProcessTemplateResult, T as TemplateError, z as ThemeMatrixCell, b as blendColors, c as colorsEqual, d as createDocumentWithText, e as createEmptyDocument, f as createRgbColor, g as createTemplateProcessor, h as createThemeColor, i as darkenColor, A as ensureHexPrefix, B as generateThemeTintShadeMatrix, j as getContrastingColor, k as getMissingVariables, l as getTemplateTags, D as getThemeTintShadeHex, m as isBlack, n as isWhite, o as lightenColor, p as parseColorString, q as previewTemplate, r as processTemplate, s as processTemplateAdvanced, F as processTemplateAndDownload, t as processTemplateAsBlob, u as processTemplateDetailed, v as resolveColor, G as resolveColorToHex, w as resolveHighlightColor, E as resolveHighlightToCss, x as resolveShadingColor, y as validateTemplate } from '../colorResolver-BCvxTlLF.mjs';
import { m as Run, P as Paragraph } from '../content-3xF4WDE8.mjs';
import { T as Theme } from '../styles-BOJ93SAm.mjs';
export { D as DocxInput, t as toArrayBuffer } from '../docxInput-DTbCa48g.mjs';
export { F as FONT_MAPPING, z as FontDefinition, I as InsertPosition, c as canRenderFont, a as countPageBreaks, b as createColumnBreak, d as createHorizontalRule, e as createLineBreak, f as createPageBreak, g as createPageBreakParagraph, h as createPageBreakRun, A as extractFontsFromDocument, i as findPageBreaks, B as getGoogleFontEquivalent, j as getLoadedFonts, k as hasPageBreakBefore, l as insertHorizontalRule, m as insertPageBreak, n as isBreakContent, o as isColumnBreak, p as isFontLoaded, r as isLineBreak, q as isLoading, s as isPageBreak, C as loadDocumentFonts, t as loadFont, D as loadFontDefinitions, u as loadFontFromBuffer, E as loadFontFromUrl, G as loadFontWithMapping, v as loadFonts, H as loadFontsWithMapping, J as onFontError, w as onFontsLoaded, x as preloadCommonFonts, y as removePageBreak } from '../fontLoader-CUS1BPv7.mjs';
