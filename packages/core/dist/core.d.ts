...
export { s as serializeDocumentBody, a as serializeDocx, b as serializeSectionProperties } from './sectionPropertiesSerializer-uXyGONxu.js';
...
export { C as CreateEmptyDocumentOptions, P as ProcessTemplateOptions, a as ProcessTemplateResult, z as ThemeMatrixCell, b as blendColors, c as colorsEqual, d as createDocumentWithText, e as createEmptyDocument, f as createRgbColor, h as createThemeColor, i as darkenColor, A as ensureHexPrefix, B as generateThemeTintShadeMatrix, j as getContrastingColor, l as getTemplateTags, D as getThemeTintShadeHex, m as isBlack, n as isWhite, o as lightenColor, p as parseColorString, r as processTemplate, t as processTemplateAsBlob, u as processTemplateDetailed, v as resolveColor, w as resolveHighlightColor, E as resolveHighlightToCss, x as resolveShadingColor, y as validateTemplate } from './colorResolver-8A-qj-LP.js';
export { A as AgentContextOptions, D as DocumentAgent, E as ExtendedSelectionContext, e as SelectionContextOptions, f as buildExtendedSelectionContext, g as buildSelectionContext, k as executeCommand, l as executeCommands, m as getAgentContext, n as getDocumentSummary } from './selectionContext-BPAqgNgk.js';
...
export { V as VariableDetectionResult, a as VariableOccurrence, d as detectVariables, b as detectVariablesDetailed, c as detectVariablesInBody, e as detectVariablesInParagraph, f as documentHasVariables, g as extractVariablesFromText, h as formatVariable, i as hasTemplateVariables, j as isValidVariableName, p as parseVariable, r as removeVariables, k as replaceVariables, s as sanitizeVariableName } from './variableDetector-1mxzPfs2.js';
import { Document } from './types/document.js';
export { DocxPackage } from './types/document.js';
export { AIAction, AIActionRequest, AgentCommand, AgentContext, AgentResponse, ApplyStyleCommand, DeleteTextCommand, FormatTextCommand, InsertHyperlinkCommand, InsertImageCommand, InsertTableCommand, InsertTextCommand, ParagraphContext, Position, Range, ReplaceTextCommand, SelectionContext, SetVariableCommand, SuggestedAction } from './types/agentApi.js';
export { EditorPluginCore, PanelConfig, PluginPanelProps, PositionCoordinates, RenderedDomContext } from './plugin-api/types.js';
export { C as CorePlugin, e as McpSession, M as McpToolDefinition, i as McpToolHandler, j as McpToolResult } from './types-DDQWU7-j.js';
export { P as PluginRegistry, p as pluginRegistry, r as registerPlugins } from './registry-egK81C_z.js';
export { docxtemplaterPlugin } from './core-plugins.js';
import { S as Subscribable } from './Subscribable-DOz6Ohoo.js';
import { ErrorManagerSnapshot, PluginLifecycleSnapshot, PluginLifecycleConfig } from './managers/types.js';
export { AutoSaveManagerOptions, AutoSaveSnapshot, AutoSaveStatus, CellCoordinates, EditorHandle, ErrorNotification, ErrorSeverity, SavedDocumentData, TableSelectionSnapshot } from './managers/types.js';
export { AutoSaveManager, formatLastSaveTime, formatStorageSize, getAutoSaveStatusLabel, getAutoSaveStorageSize, isAutoSaveSupported } from './managers/AutoSaveManager.js';
export { TABLE_DATA_ATTRIBUTES, TableSelectionManager, deleteTableFromDocument, findTableFromClick, getTableFromDocument, updateTableInDocument } from './managers/TableSelectionManager.js';
import { m as Run } from './content-C8fc_tL6.js';
export { B as BlockContent, z as BookmarkEnd, G as BookmarkStart, e as Comment, f as CommentRangeEnd, g as CommentRangeStart, h as Deletion, D as DocumentBody, E as Endnote, V as Field, Y as FooterReference, F as Footnote, y as HeaderFooter, a0 as HeaderReference, H as Hyperlink, I as Image, i as Insertion, L as ListLevel, M as MoveFrom, j as MoveTo, k as NumberingDefinitions, P as Paragraph, l as ParagraphContent, n as RunContent, S as SectionProperties, as as Shape, T as Table, o as TableCell, p as TableRow, aD as TextBox, q as TextContent, r as TrackedChangeInfo, s as TrackedRunChange } from './content-C8fc_tL6.js';
import { EditorView } from 'prosemirror-view';
export { FlowBlock, FootnoteContent, Layout, Measure, Page } from './layout-engine/types.js';
export { P as ParagraphFormatting, T as TextFormatting } from './formatting-_OXU8gLB.js';
export { C as ConvertFootnoteOptions, a as ConvertHeaderFooterOptions, F as FOOTNOTE_SEPARATOR_HEIGHT, H as HeaderFooterMetrics, M as MAX_FOOTNOTE_LAYOUT_PASSES, b as MeasureBlocksFn, S as StabilizeFootnoteLayoutArgs, c as StabilizeFootnoteLayoutResult, d as buildFootnoteContentMap, e as buildFootnoteRenderItems, f as calculateFootnoteReservedHeights, g as collectFootnoteRefs, h as convertHeaderFooterToContent, i as footnoteReservedHeightsEqual, m as mapFootnotesToPages, s as stabilizeFootnoteLayout } from './headerFooterLayout-Df7heNer.js';
export { R as Relationship, a as Style, S as StyleDefinitions, T as Theme, f as ThemeColorScheme, g as ThemeFont, h as ThemeFontScheme } from './styles-BWqX2AS-.js';
